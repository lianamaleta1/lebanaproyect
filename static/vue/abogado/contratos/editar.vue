  ...
  <div class="row">          
          <div class="col-sm-6" style="margin-left: 25%">
            <div class="card card-primary card-outline card-outline-tabs">
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-four-home-tab" data-toggle="pill" href="#custom-tabs-four-home" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true"><i class="fa fa-plus"></i> Editar Contrato</a>
                  </li>
                </ul>
              </div>
              <div class="card-body">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form method="POST" v-on:submit.prevent="editar">
                  <div class="row">
                    <div class="col-sm-12">
                      <!-- checkbox -->
...
module.exports = {
  ...
  data(){
   return{
    contrato:{
      id:this.$route.params.id_contrato,
  ...
  methods: {
    ...
    editar:function(){
     var url='https://'+document.location.hostname+':'+document.location.port+'/solicitud_pago/sistema/editar_contrato/'+this.contrato.id+'/';

      const fd =new FormData();
      fd.append('id',this.contrato.id);      
      ...
      get_editar:function(){  
      this.errors=[];
      var url='https://'+document.location.hostname+':'+document.location.port+'/solicitud_pago/sistema/detalles_contrato/'+this.contrato.id+'/';
      axios.get(url).then(response => {
         this.contrato.descripcion=response.data[0].descripcion;
         this.contrato.tcp=response.data[0].tcp;
         $('#tcp').val(this.contrato.tcp);
         $('#tcp').select2().trigger('change');
         this.contrato.fecha_vencimiento=response.data[0].fecha_vencimiento;
         this.contrato.actual=response.data[0].modelo;
         this.contrato.estado=response.data[0].estado;
         $('#estado').val(this.contrato.estado);
