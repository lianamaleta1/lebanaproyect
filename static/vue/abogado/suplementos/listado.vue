          ...
          <div class="col-12 col-sm-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><i class="fa fa-list"></i> Listado de contratos </h3>                 
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              	<div class="row">
                 ...
                 <div id="botones" style="margin-bottom: 5px;text-align: right;" class="col-sm-2">
                	<a href="#/contrato_adicionar" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> Adicionar contrato</a>
                 </div>
              	</div>
  ...
  mounted(){
    ...
    vm=this;
        ...
        var data = tablee.row( $(this).parents('tr') ).data();
           localStorage.setItem('eliminar_contrato',data.id);
           $('#descripcion').text(data.descripcion);
           $("#tcp").text(data.tcp__nombre);
           $("#estado").text(data.estado);
           $("#fecha").text(data.fecha_vencimiento);
           $('#delete').modal('show');
     ...
     $('#tabla_solicitudes').on( 'click', 'tbody tr .btn-primary', function () {
        tablee=$('#tabla_solicitudes').DataTable(); 
        var data = tablee.row( $(this).parents('tr') ).data();
        window.location='#/contrato_editar/'+data.id;
