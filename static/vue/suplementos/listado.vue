            ...
            <div class="card card-primary card-outline card-outline-tabs">
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-four-profile-tab" data-toggle="pill" href="#custom-tabs-four-profile" role="tab" aria-controls="custom-tabs-four-profile" aria-selected="false"><i class="fa fa-list"></i> Listado de Suplementos </a>
                  </li>
                </ul>
              </div>
              <div class="card-body">
              ...
              <div class="card-body">
                ...
                <table id="tabla_solicitudes" class="table table-bordered table-striped"> 
                  ...
                  <tr>
                        ...
                        <td align="center" data-column="7"><input type="text" placeholder="" class="column_filter 
                        form-control" style="width: 100%" id="col7_filter"></td>
...
module.exports = {
  ...
  methods: {
    get_lista_contratos:function(){
      ...
      var url='https://'+document.location.hostname+':'+document.location.port+'/solicitud_pago/sistema/listado_suplemento/';
